...
impl defmt::Format for Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl {{ mode: {:?}, new_hash: {=bool:?}, reload: {=bool:?}, dma_i: {:?}, dma_o: {=bool:?}, hashswpb: {=bool:?} }}",
            self.mode(),
            self.new_hash(),
            self.reload(),
            self.dma_i(),
...
impl core::fmt::Debug for PrngOut {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PrngOut")
            .field("prng_out", &self.prng_out())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for PrngOut {
    fn format(&self, f: defmt::Formatter) {
...
impl core::fmt::Debug for PrngSeed {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PrngSeed")
            .field("prng_seed", &self.prng_seed())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for PrngSeed {
    fn format(&self, f: defmt::Formatter) {
